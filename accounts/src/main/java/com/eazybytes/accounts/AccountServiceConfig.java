...
public class AccountServiceConfig {
	...
	public AccountServiceConfig(String msg, String buildVersion, Map<String, String> mailDetails,
	...
	public String toString() {
		return "AccountServiceConfig [msg=" + msg + ", buildVersion=" + buildVersion + ", mailDetails=" + mailDetails
